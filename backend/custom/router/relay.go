...
func SetRelayRouter(router *gin.Engine) {
	...
	// T-004: Native API passthrough routes — transparent forwarding with vendor-specific auth
	passthroughRouter := router.Group("/passthrough")
	passthroughRouter.Use(middleware.RelayPanicRecover(), middleware.TokenAuth(), middleware.Distribute())
	{
		passthroughRouter.Any("/*path", controller.RelayPassthrough)
	}
