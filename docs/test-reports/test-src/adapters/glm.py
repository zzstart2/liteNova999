...
class GLMAdapter(BaseAdapter):
    ...
    async def list_models(self):
        return [
            ModelInfo(id="glm-4", name="GLM-4", context_length=128000, provider=self.PROVIDER_NAME),
            ModelInfo(id="glm-4-flash", name="GLM-4 Flash", context_length=128000, provider=self.PROVIDER_NAME),
            ModelInfo(id="glm-3-turbo", name="GLM-3 Turbo", context_length=128000, provider=self.PROVIDER_NAME),
        ]
