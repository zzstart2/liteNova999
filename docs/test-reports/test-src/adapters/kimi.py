...
class KimiAdapter(BaseAdapter):
    ...
    async def list_models(self):
        return [
            ModelInfo(id="moonshot-v1-8k", name="Moonshot v1 8K", context_length=8192, provider=self.PROVIDER_NAME),
            ModelInfo(id="moonshot-v1-32k", name="Moonshot v1 32K", context_length=32768, provider=self.PROVIDER_NAME),
            ModelInfo(id="moonshot-v1-128k", name="Moonshot v1 128K", context_length=131072, provider=self.PROVIDER_NAME),
        ]
