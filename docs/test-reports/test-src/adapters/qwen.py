"""千问 (通义千问 / DashScope) 适配器 — OpenAI 兼容"""
...
class QwenAdapter(BaseAdapter):
    ...
    async def list_models(self):
        return [
            ModelInfo(id="qwen-turbo", name="Qwen Turbo", context_length=131072, provider=self.PROVIDER_NAME),
            ModelInfo(id="qwen-plus", name="Qwen Plus", context_length=131072, provider=self.PROVIDER_NAME),
            ModelInfo(id="qwen-max", name="Qwen Max", context_length=32768, provider=self.PROVIDER_NAME),
        ]
